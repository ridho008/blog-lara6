        ...
        <div id="nav">
                ...
                <div class="container">
                    ...
                    <div class="nav-logo">
                        <a href="{{ url('/') }}" class="logo"><img
                                src="{{ asset('uploads/logo/' . $setting->logo) }}" alt="{{ $setting->logo }}"></a>
                    </div>
                    <!-- /logo -->
            ...
            <div id="nav-bottom">
                <div class="container">
                    ...
                    <ul class="nav-menu">
                        <li><a href="{{ url('/') }}"
                                @if (Request::path() == '/') style="color:#ee4462;" @endif>Home</a></li>
                        ...
                        <li><a href="{{ route('blog.list') }}"
                                @if (Request::path() == 'list-posts') style="color:#ee4462;" @endif>List Post</a></li>
                        <li><a href="{{ route('blog.about') }}"
                                @if (Request::path() == 'about') style="color:#ee4462;" @endif>About</a></li>
