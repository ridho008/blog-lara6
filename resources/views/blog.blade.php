         ...
         <div class="row">
            <div class="col-md-8">
               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <div class="post">
                        <a class="post-img" href="blog-post.html"><img src="{{ asset('uploads/posts/'. $posts->photo) }}" alt="{{ $posts->title }}"></a>
                        <div class="post-body">
                           <div class="post-category">
                              <a href="category.html">{{ $posts->categori->name }}</a>
                           </div>
                           <h3 class="post-title"><a href="blog-post.html">{{ $posts->title }}</a></h3>
                           <ul class="post-meta">
